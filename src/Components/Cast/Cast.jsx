    ...
    <Sliders>
      {
        castDetails.map(cast => (
                                        <div className="castImage">
                                          <img src={ cast && cast.profile_path ? `https://image.tmdb.org/t/p/original${cast.profile_path}` : 'https://via.placeholder.com/200x300'} />
                                          <p>{cast && cast.name}</p>
                                          <p>as</p>
                                          <h4 style={{ wordWrap: 'break-word' }}>{cast && cast.character}</h4>
                                        </div>
                                  ))
      }
    </Sliders>
